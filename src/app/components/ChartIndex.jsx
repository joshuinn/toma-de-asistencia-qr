      ...
      <div className="p-3 w-full h-full">
        <div className="w-full flex flex-wrap justify-between items-center gap-2">
            ...
            >
              <div>
                ...
                <input
                  ...
                  name="ciclo"
                  placeholder="Ciclo"
                  className="rounded-full bg-blue-800 p-3 outline-none mx-2"
          ...
          <div className="flex gap-5 bg-blue-600 p-4 rounded-lg shadow-lg">
            <button
              className="p-3 bg-purple rounded-lg border border-purple hover:text-purple hover:bg-blue-600 transition-all flex items-center gap-2"
              onClick={selectAll}
            >
              Seleccionar Todo
              <FaListCheck size={20} />
            ...
            <button
              className="bg-pink p-3 rounded-lg border border-pink hover:bg-blue-600 hover:text-pink transition-all flex items-center gap-2"
              onClick={calculate}
            >
              Calcular 
              <BiMath size={20} />
